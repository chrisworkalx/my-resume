...
- 依据设计完成静态页面的构建
- 实现产品的效果
- 负责配合后台开发人员完成数据展示、功能实现等
- fix迭代开发产生的bug，优化产品功能
...
**技术栈**  vue + vue-router + webpack + axios

**项目介绍** 起点银行是为了实现客户定期存款、投资理财、货币基金等产品投资需求。是一个Vue的项目。通过精简产品数量，提升品类的竞争力并做出差异化

**项目职责：**

- 针对效果图和产品的需求，进行项目开发
- 配合安卓工程师，负责app 内部 HTML 页面的实现
- 负责与后台程序员及时沟通，调试接口，数据展示
- 与项目负责人及时沟通，优化页面，修改完善

### 苏州银行公司金融(公众号)

**时间：** 2017.10 - 2018.02

**技术栈**  vue + vue-router + vuex + JS-SDK

**项目介绍** 这是一款企业服务公众号,通过微账户，微金融，微服务等推广公司的理财产品并实时客户端管理系统
