...
- 参与设计人员对产品的交互以及用户体验设计并对产品提出改进反馈和调整
- Web产品前端的设计与开发，开发文档编写
- 产品功能开发及性能优化等
- 部署产品上线等
...
**技术栈：** vue3 + antdesign-vue + vue-router4 + pinia + typescript

**项目介绍：** 企业家管理系统主要是为挖掘潜在的客户群体并服务于私人定制及家族化穿透的管理系统、包括设有管理员、经理、多个管家、及客户不同角色

**项目职责：**

- 基于开源的vben管理系统二次开发功能页面
- 根据公司现有的工作流设计模式开设的新的流程图完成页面的绘制以及动态交互
- http前后端交互冒烟，全局调试，统一配置通用Api
- 基于agrid封装通用表格（支持拖拽、排序、检索字段等）
- 页面路由配置、国际化配置等
- 完善部分现有的通用组件并增加一些页面组件的开发（锚点导航组件，上传组件、加解密组件等）
- 首页图表echarts展示、需求分析页甘特图绘制
- 增加一些基础通用方法，（字典值的统一使用、鉴权方法的封装等）
