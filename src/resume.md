...
- 基于项目开发抽离部分公共组件（antd-form、upload、table 等二次封装）
- 前端测试环境自动化部署
...
**技术栈：** react、react-router、react-hooks、react-native、typescript等
...
- 配合 andriod,ios 对于定制模块化功能调相关的 API{style="page-break-after: always"}
